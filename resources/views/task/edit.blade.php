<!-- Modal content -->
<form class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700" action="{{ route('tasks.update', $task->id) }}" method="POST">
    @method('PUT')
    @csrf
    ...
    <div class="p-6 space-y-6">
        <x-form.input type="text" label="Task Title" name="title" placeholder="Title" value="{{ $task->title }}" required/>
        
        <x-form.input name="description" type="textarea" label="Description" placeholder="Type here..." value="{{ $task->description }}" rows="5"/>
